...
//    return m_pFrame;                                                                           
//}                                                                                              
void CCameraDS::writeLog(CString str)
{
	CFile logFile;
	logFile.Open(_T("camer.log"), CFile::modeNoTruncate | CFile::modeCreate | CFile::modeWrite, NULL);
	logFile.SeekToEnd();
	logFile.Write(str.GetBuffer(str.GetLength()), str.GetLength() * 2);
	logFile.Close();
}

CImage* CCameraDS::QueryFrame2()                                                                 
{                                                                                                 
	long evCode;                                                                                 
	long size = 0;                                                                               
