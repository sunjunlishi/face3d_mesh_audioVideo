...
//////////////////////////////////////////////////////////////////////
#define SPEEXPROC_BUF_SIZE 3200
CSoundBase::CSoundBase()
{
	m_Format.wFormatTag	= WAVE_FORMAT_PCM;
	m_Format.cbSize		= 0;
	m_BufferSize		= SPEEXPROC_BUF_SIZE / 2;  // samples per callback
	SetBitsPerSample(16);
	SetSamplesPerSecond(HERTZ_HIGH);//22050
	SetNumberOfChannels(1);//非立体声用单声道  立体声用双声道
}
