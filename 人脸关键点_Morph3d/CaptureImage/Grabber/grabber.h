...
typedef  HRESULT(__stdcall *SAMPLECALLBACK) (
	IMediaSample * pSample);

class  CGrabsampleCallback
{
public:
	HRESULT  ProcMedia(IMediaSample * pSample) { return NOERROR; };
...
IGrabberSample : public IUnknown
{
    public:
		...
		virtual HRESULT STDMETHODCALLTYPE SetGrabSampleCallback(
			CGrabsampleCallback * Callback) = 0;
...
protected:
	...
	CGrabsampleCallback * m_grabBack;
public:
	...
	STDMETHODIMP SetGrabSampleCallback(CGrabsampleCallback * Callback);
