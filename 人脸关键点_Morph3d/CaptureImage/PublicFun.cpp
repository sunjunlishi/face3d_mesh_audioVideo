...
namespace PublicFun
{
	...
	void CreateFileName(CString &strName,CString &strfilename)
	{
		...
		int len = WideCharToMultiByte(CP_ACP, 0, strName, -1, NULL, 0, NULL, NULL);  
		char* buf2 = (char*)calloc(len, sizeof(char));                                           
		WideCharToMultiByte(CP_ACP, 0, strName, -1, buf2, len, NULL, NULL);  	                                                                                            
		MakeSureDirectoryPathExists(buf2);
