========================================================================
    ACTIVEX 控件 DLL : AgCamera 项目概述
========================================================================

控件向导已为 AgCamera ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 AgCamera ActiveX 控件 DLL 的每个文件的内容。
...
AgCameraCtrl.h
    此文件包含 CAgCameraCtrl C++ 类的声明。

AgCameraCtrl.cpp
    此文件包含 CAgCameraCtrl C++ 类的实现。

AgCameraPropPage.h
    此文件包含 CAgCameraPropPage C++ 类的声明。

AgCameraPropPage.cpp
    此文件包含 CAgCameraPropPage C++ 类的实现。

CAgCameraCtrl.bmp
    此文件包含一个位图，当 CAgCameraCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 AgCamera.pch 的预编译头 (PCH) 文件和名为 
